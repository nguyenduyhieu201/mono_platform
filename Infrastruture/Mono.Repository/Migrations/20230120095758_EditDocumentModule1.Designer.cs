...
namespace Mono.Repository.Migrations
{
    ...
    [Migration("20230120095758_EditDocumentModule1")]
    partial class EditDocumentModule1
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Mono.SharedLibrary.Models.DocumentType", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Guid = new Guid("d1a0adfe-41ea-487f-8536-3719564b0d3b"),
                            Titleen = "Report",
                            Titlevi = "Tờ trình"
                        },
                        new
                        {
                            Id = 2,
                            Guid = new Guid("fa99c43a-db2a-4359-b986-2eed7a28453c"),
                            Titleen = "Dispatch",
                            Titlevi = "Công văn"
                        },
                        new
                        {
                            Id = 3,
                            Guid = new Guid("fe68e0d3-6220-4468-b331-cae3b435c90c"),
                            Titleen = "Decision",
                            Titlevi = "Quyết định"
                        },
                        new
                        {
                            Id = 4,
                            Guid = new Guid("3a12091d-aa25-4c5e-8036-6026f80285fc"),
                            Titleen = "Resolution",
                            Titlevi = "Nghị quyết"
                        },
                        new
                        {
                            Id = 5,
                            Guid = new Guid("cf18f3ab-f4b3-449c-8a01-146af89f6ac1"),
                            Titleen = "Command",
                            Titlevi = "Chỉ thị"
                        });
                });
